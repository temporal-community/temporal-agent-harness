...
from durable_tools_gateway.registry_service_handler import ExternalMCPCallInput
from durable_tools_gateway.tool_history import (
...
async def test_native_scan_resolves_only_account_session_workflow_namespaces() -> None:
    ...
    with patch(
        "durable_tools_gateway.tool_history._native_calls_from_history",
