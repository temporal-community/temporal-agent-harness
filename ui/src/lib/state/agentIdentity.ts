 ...
 * without a browser or a Svelte compile step: npx vitest run src/lib/state/replayTimeline.test.mjs.
 */
 ...
 * Fixtures conform to `AgentId` instead; replayTimeline.test.mjs asserts it.
 *
