...
# every page cross that warning boundary more than once on its way through the broker.
...
def bounded_poll_result(
    ...
    *,
    ...
    Temporal boundaries (the Nexus operation and broker publish activity), so impose the smaller
