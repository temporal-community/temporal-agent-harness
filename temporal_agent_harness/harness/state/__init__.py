...
# A workflow author declares state by subclassing HarnessState and opts in with one call
# to ``AgentWorkflowRunner.state(...)``; from then on every change made inside a
